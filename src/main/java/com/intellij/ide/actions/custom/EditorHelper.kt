...
object EditorHelper {
    ...
    fun scrollLineToScreenLine(editor: Editor) {
        ...
        scrollLineToTopOfScreen(editor, normalizeVisualLine(editor, visualLine))
    }
    ...
    private fun moveToLeft(editor: Editor) {
        ...
        val visualColumn = getVisualColumnAtLeftOfScreen(editor)
        val width = getScreenWidth(editor)
    ...
    private fun moveToTop(editor: Editor) {
        ...
        val visualLine = getVisualLineAtTopOfScreen(editor)
        ...
        if (diff != 0) {
            ...
            line = Math.min(line, getVisualLineCount(editor) - height)
    ...
    private fun scrollColumnToLeftOfScreen(editor: Editor, column: Int) {
        editor.scrollingModel.scrollHorizontally(column * getColumnWidth(editor))
    }
